...
class canva:
    ...
    def streamlit_config(self):
        ...
        # page configuration
        st.set_page_config(page_title='Canva', layout="wide")
        ...
        # title and position
        st.markdown(f'<h1 style="text-align: center;">Virtual Canva</h1>',
    ...
    def __init__(self):
        ...
        self.mphands = hands.Hands(max_num_hands=2, min_detection_confidence=0.75)
        ...
        if self.landmark_list != []:
            ...
            for i in range(0, 5):
                if self.fingers[i] == 1:
                    ...
                    cv2.circle(img=self.img, center=(cx, cy), radius=5, color=(255,255,255,0), thickness=1)
    ...
    def handle_drawing_mode(self):
        ...
        if sum(self.fingers) == 2 and self.fingers[0] == self.fingers[1] == 1:
            ...
            cv2.line(img=self.imgCanvas, pt1=(self.p1, self.p2), pt2=(cx, cy), color=(255, 255, 255), thickness=7)
    ...
    def main(self):
        ...
        col1, _, col3 = st.columns([0.9, 0.01, 00.01])
