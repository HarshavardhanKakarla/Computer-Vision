...
class calculator:
    ...
    def streamlit_config(self):
        ...
        # title and position
        st.markdown(f'<h1 style="text-align: center;">Virtual Calculator and Canva</h1>',
    ...
    def handle_drawing_mode(self):
        ...
        if sum(self.fingers) == 2 and self.fingers[0] == self.fingers[1] == 1:
            ...
            cv2.line(img=self.imgCanvas, pt1=(self.p1, self.p2), pt2=(cx, cy), color=(255, 255, 255), thickness=5)
